...
gulp.task('default', function() {
    ...
    buildJSMain(SRC_ROOT+'/js/neemVisualizationTaskTree.js', 'neemVisualizationTaskTree.js', BUILD_ROOT, true,true);
    moveIndexHTML(BUILD_ROOT);
});

gulp.task('debug', function () {
    buildCSSMain(SRC_ROOT, DEBUG_ROOT);
    buildJSMain(SRC_ROOT+'/js/neemVisualizationTaskTree.js', 'neemVisualizationTaskTree.js', DEBUG_ROOT, true,false);
